...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    public void YOLO(View Button){
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                ...
                Log.i("tinyLocation" , "Tiny Weights: " + tinyYoloWeights + "\nTiny CFG: " + tinyYoloCfg);
    ...
    public void onCameraViewStarted(int width, int height) {
        if (startYolo == true){
            String tinyYoloCfg = Environment.getExternalStorageDirectory() + "/dnns/yolov-obj.cfg" ;
            String tinyYoloWeights = Environment.getExternalStorageDirectory() + "/dnns/yolov-obj.weights";
            Log.i("tinyLocation" , "Tiny Weights: " + tinyYoloWeights + "\nTiny CFG: " + tinyYoloCfg);
            tinyYolo = Dnn.readNetFromDarknet(tinyYoloCfg, tinyYoloWeights);
        }
    }
